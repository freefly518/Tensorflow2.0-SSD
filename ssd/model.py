...
class SSD(tf.keras.Model):
    def __init__(self, num_classes=21,
        ...
        self.conv5_1 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same", activation='relu', name='block_conv5_1')
        self.conv5_2 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same", activation='relu', name='block_conv5_2')
        self.conv5_3 = layers.Conv2D(filters=512, kernel_size=(3, 3), strides=1, padding="same", activation='relu',  name='block_conv5_3')

        self.conv6 = layers.Conv2D(filters=1024, kernel_size=(3, 3), strides=1, padding="same", dilation_rate=(6, 6), activation='relu', name='block_conv6')

        self.conv7 = layers.Conv2D(filters=1024, kernel_size=(1, 1), activation='relu', name='block_conv7')

        self.conv8_1 = layers.Conv2D(filters=1024, kernel_size=(1, 1), activation='relu', name='block_conv8_1')
        self.conv8_2 = layers.Conv2D(filters=1024, kernel_size=(3, 3), strides=2, padding="same", activation='relu', name='block_conv8_2')

        self.conv9_1 = layers.Conv2D(filters=128, kernel_size=(1, 1), activation='relu', name='block_conv9_1')
        self.conv9_2 = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="same", strides=2, activation='relu', name='block_conv9_2')

        self.conv10_1 = layers.Conv2D(filters=128, kernel_size=(1, 1), activation='relu', name='block_conv10_1')
        self.conv10_2 = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="valid", activation='relu', name='block_conv10_2')

        self.conv11_1 = layers.Conv2D(filters=128, kernel_size=(1, 1), activation='relu', name='block_conv11_1')
        self.conv11_2 = layers.Conv2D(filters=256, kernel_size=(3, 3), padding="valid", activation='relu', name='block_conv11_2')
    ...
    def call(self, inputs, training=True):
        ...
        confs = [tf.reshape(i, [batch_size, -1, self.num_classes]) for i in confs]
        locs = [tf.reshape(i, [batch_size, -1, 4]) for i in locs]
